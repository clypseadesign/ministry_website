  ...
  return (
    <div>
      ...
      <section className="section" style={{ background: '#ffffff', padding: '64px 0 32px 0' }}>
        <div className="container-narrow" style={{ maxWidth: '840px', margin: '0 auto', textAlign: 'center' }}>
          <h2 className="section-title" style={{ fontSize: '2.6rem', color: '#005595', marginBottom: '20px', fontFamily: 'var(--font-heading-fancy)' }}>
        ...
        {/* 6 Cards Grid - Exact Match to Screenshot */}
      ...
      <section className="section" style={{ background: '#ffffff', padding: '64px 0 80px 0', textAlign: 'center' }}>
        <div className="container">
          <h2 className="section-title" style={{ fontSize: '2.6rem', color: '#005595', marginBottom: '48px', fontFamily: 'var(--font-heading-fancy)' }}>
            OUR GLOBAL IMPACT
          </h2>
          <StatsCounter />
        </div>
